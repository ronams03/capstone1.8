export const PRIVACY_POLICY_DEFAULT_HTML = `<h1>Privacy Policy</h1>
...
<li>
<p><strong>Application</strong> refers to LLB ACCOUNTANTS, the software program provided by the Company.</p>
</li>
<li>
<p><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Privacy Policy) refers to LLB Accountants, 2/F Bato Building,. Coastal Road, Zone 1,. Kauswagan Cagayan. de Oro City, 9000.</p>
</li>
<li>
...
<ul>
<li>By email: llbandcocpas@gmail.com</li>
</ul>`;
